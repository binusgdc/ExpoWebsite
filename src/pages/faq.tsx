...
export default function Faq() {
    ...
    return (
        <>
            ...
            <BgdcNav />
            <main className="min-h-screen bg-magenta pt-16">
                <Typography
                    variant="h1"
                    color="white"
                ...
                <div id="faq" className="mx-auto w-full max-w-4xl px-16 py-6">
                    <Accordion open={aboutOpen}>
                        ...
                        <AccordionBody>
                            <Card color="deep-orange" className="p-5">
                    ...
                    <Accordion open={registrationOpen}>
                        ...
                        <AccordionBody>
                            <Card color="deep-orange" className="p-5">
                                ...
                                <Typography variant="paragraph" color="white">
                                    Biaya pendaftaran member BGDC adalah sebesar 100 ribu rupiah.
                                </Typography>
                                <br />
                                <Typography variant="h6" color="white">
                    ...
                    <Accordion open={classOpen}>
                        ...
                        <AccordionBody>
                            <Card color="deep-orange" className="p-5">
                                <Typography variant="h6" color="white">
                                    Berapa besar biaya yang diperlukan untuk bergabung dengan kelas
                                    BGDC?
                                </Typography>
                                <Typography variant="paragraph" color="white">
                                    Rp 50.000,00
                                ...
                                <Typography variant="paragraph" color="white">
                                    Iya, kalian akan diberikan akses untuk semua kelas dan rekaman
                                    kelas.
                                </Typography>
                                <br />
                            </Card>
